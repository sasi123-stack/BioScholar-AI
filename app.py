...
async def ai_reply(update: Update, user_id: int, prompt: str, save_user_msg: bool = True):
    ...
    try:
        ...
        if not answer: raise Exception("All models failed")
...
if __name__ == '__main__':
    ...
    # Detect environment proxy (Critical for Hugging Face Spaces)
    ...
    request = HTTPXRequest(connect_timeout=30, read_timeout=30, proxy_url=proxy_url)
